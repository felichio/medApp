<div class="container">
    ...
    <fieldset>
        <legend>Register Drug</legend>
        <form class="form-horizontal form-input" action="admin_drug_insert.php" method="POST">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  <input type="text" class="form-control" id="inputDosage" placeholder="Dosage" name="dosage">
                </div>
              </div>
              <div class="form-group">
