<div class="container">
    ...
    <fieldset>
        ...
        <form class="form-horizontal form-input" action="doctor_pat_insert.php" method="POST">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  <input type="text" class="form-control" id="inputAmka" placeholder="AMKA" name="amka">
                </div>
              </div>
              <div class="form-group">
